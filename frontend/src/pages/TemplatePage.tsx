const templates = [
  ...
  },
  {
    ...
    tagBg: "#bbf7d0",
    title: "상추 성장 촉진",
    desc: "LED 보광과 CO₂ 농도 제어로 수확 주기를 단축하는 알고리즘입니다.",
  },
  {
    icon: "❄",
    iconBg: "#ede9fe",
  ...
  return (
    <>
      <div className="ff-page-head">
        ...
        <p className="ff-sub">
          검증된 농업 알고리즘 템플릿을 선택해 기후·수분·양분 공급 로직을 빠르게
          적용하고 수정할 수 있습니다.
        </p>
      </div>
      <main className="tpl-main">
        <div className="tpl-grid">
          <div className="tpl-card tpl-card--new">
          ...
          {templates.map((t) => (
            <article key={t.title} className="tpl-card">
              ...
              <div className="tpl-actions">
                <button type="button" className="tpl-btn-outline">
                  상세 보기
                </button>
