      ...
      (e: React.DragEvent) => {
        ...
        setNodes((nds) =>
          nds.concat({
            ...
            type,
            position,
            data: { name: deviceName || undefined },
            selected: false,
          }),
        );
      },
          ...
          <aside className="ff-palette" aria-label="블록 라이브러리">
            ...
            <div className="ff-palette-section">
              ...
              <div
                ...
                draggable
                onDragStart={(e) => onPaletteDragStart(e, "sensor", "온도 센서")}
              >
              ...
              <div
                className="ff-bar ff-bar--sensor"
                draggable
                onDragStart={(e) => onPaletteDragStart(e, "sensor", "습도 센서")}
              >
            ...
            <div className="ff-palette-section">
              ...
              <div
                ...
                draggable
                onDragStart={(e) => onPaletteDragStart(e, "action", "환기 제어")}
              >
              ...
              <div
                className="ff-bar ff-bar--action"
                draggable
                onDragStart={(e) => onPaletteDragStart(e, "action", "관수 펌프")}
              >
