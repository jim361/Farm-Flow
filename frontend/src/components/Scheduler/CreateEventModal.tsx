// 역할: 새 일정을 입력하고 저장하는 생성 전용 모달 컴포넌트입니다.
...
const CreateEventModal = ({ open, defaultDate, onClose, onCreate }: CreateEventModalProps) => {
  ...
  const submit = () => {
    ...
    // 한글 주석: 새 일정 입력 데이터를 상위 상태로 전달해 일정 배열에 즉시 반영합니다.
    onCreate({
  ...
  return (
    <div
      ...
      style={{
        position: 'fixed',
        inset: 0,
        backgroundColor: 'rgba(18, 33, 25, 0.5)',
        display: 'flex',
        alignItems: 'center',
